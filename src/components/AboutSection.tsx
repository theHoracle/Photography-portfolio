  ...
  return (
    <div>
      ...
      <div className="md:flex items-center justify-between md:gap-3 md:mt-8">
        <div className="relative overflow-hidden rounded-2xl lg:max-h-[480px] my-8 md:m-0  w-full">
          <Image
        ...
        <div className="my-6 border divide-y border-accent p-4 md:p-8 rounded-2xl w-full ">
          <div className="mb-8">
          ...
          <div className="lg:flex items-center gap-3 justify-between lg:tracking-tighter ">
            <SocialIcons />
            <div className="flex flex-col mt-8 lg:mt-0 lg:flex-row items-center justify-between gap-4">
              <Button
              variant="outline"
                className="w-full py-5 text-xs lg:text-lg lg:tracking-tighter lg:w-max"
              >
                Let&apos;s Work
              </Button>
              <Button
