  ...
  return (
    <div>
      ...
      <div className="md:flex items-center justify-between md:gap-3 md:mt-8">
        ...
        <div className="my-6 all-border text-accent-color border-border-primary md:p-8 rounded-2xl w-full ">
          <div className="mb-8">
          ...
          <div className="py-8 md:mx-[-2rem] md:px-8 border-t border-color">
            <Heading size="sm" className="capitalize my-3">
              Contact Information
            </Heading>
